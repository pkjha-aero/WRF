...
print *,'INFMAX,INFMAX1,HYDRO(1)*SOILIQW(1),-TOTLIQ', &
  ...
  10   I1=I
   ...
   1   PRINT *,'     AVOST IN VILKA     Table index= ',I
       ...
       CALL wrf_error_fatal3("module_sf_ruclsm.b",6272,&
'  Crash in surface energy budget  ' )
 ...
 IF(.not.restart)THEN
   ...
   IF ( errflag .EQ. 1 ) THEN
      CALL wrf_error_fatal3("module_sf_ruclsm.b",6853,&
  ...
  END SUBROUTINE ruclsminit
       ...
       IF ( wrf_dm_on_monitor() ) THEN
        ...
        IF(ierr .NE. OPEN_OK ) THEN
          ...
          CALL wrf_error_fatal3("module_sf_ruclsm.b",6989,&
message )
        END IF
 ...
 2002   CONTINUE
    ...
    ENDIF
        ...
        IF (LUMATCH == 0) then
           CALL wrf_error_fatal3("module_sf_ruclsm.b",7062,&
"Land Use Dataset '"//MMINLURUC//"' not found in VEGPARM.TBL.")
      ...
      IF ( wrf_dm_on_monitor() ) THEN
        ...
        IF(ierr .NE. OPEN_OK ) THEN
          ...
          CALL wrf_error_fatal3("module_sf_ruclsm.b",7100,&
message )
        END IF
 ...
 2003   CONTINUE
      ...
      IF(LUMATCH.EQ.0)THEN
          ...
          CALL wrf_error_fatal3("module_sf_ruclsm.b",7161,&
'INCONSISTENT OR MISSING SOILPARM FILE' )
      ...
      IF ( wrf_dm_on_monitor() ) THEN
        ...
        IF(ierr .NE. OPEN_OK ) THEN
          ...
          CALL wrf_error_fatal3("module_sf_ruclsm.b",7173,&
message )
        END IF
